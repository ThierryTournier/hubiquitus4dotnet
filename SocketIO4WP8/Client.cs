...
namespace SocketIOClient
{
    ...
    public class Client : IDisposable, SocketIOClient.IClient
    {
        ...
        private SocketIO4Net.Helpers.WebSocketState mwsState = SocketIO4Net.Helpers.WebSocketState.None;
        /// <summary>
        ...
        public bool IsConnected
        {
            get
            {
                return this.ReadyState == SocketIO4Net.Helpers.WebSocketState.Connected;
            }
        }
        ...
        /// </summary>
        public SocketIO4Net.Helpers.WebSocketState ReadyState
        {
            get
            {
        ...
        {
            if (!(this.ReadyState == SocketIO4Net.Helpers.WebSocketState.Connecting || this.ReadyState == SocketIO4Net.Helpers.WebSocketState.Connected))
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        this.mwsState = SocketIO4Net.Helpers.WebSocketState.Connecting;
                        this.mws.Open();
                        this.mwsState = SocketIO4Net.Helpers.WebSocketState.Connected;
                        mws_OpenEvent();
                    }
                }
                catch (Exception ex)
                {
                    this.mwsState = SocketIO4Net.Helpers.WebSocketState.Closed;
        ...
        public void Close()
        {
            this.mwsState = SocketIO4Net.Helpers.WebSocketState.Closing;
        ...
        protected void closeWebSocketClient()
        {
            if (this.mws != null)
            {
                ...
                if (this.mwsState != SocketIO4Net.Helpers.WebSocketState.Closed)
                {
        ...
        {
            if (this.ReadyState == SocketIO4Net.Helpers.WebSocketState.Connected)
            {
